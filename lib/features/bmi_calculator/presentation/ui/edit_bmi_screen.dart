...
class EditBmiFrom extends StatefulWidget {
  final String id;
  const EditBmiFrom({super.key, required this.id});

  @override
  State<EditBmiFrom> createState() => _EditBmiFromState();
}

class _EditBmiFromState extends State<EditBmiFrom> {
  @override
  void initState() {
    _bind();
    super.initState();
  ...
  _bind() {
    context.read<BmiCubit>().getBmiById(widget.id);
  }
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  AppTextButton(
                    onPressed: () {
                      bmiController.updateCalculatBMI(widget.id, context);
                    },
